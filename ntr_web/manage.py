...
from ntr_web.app import create_app
from ntr_web.database import db
from ntr_web.settings import DevConfig, ProdConfig
from ntr_web.user.models import User

CONFIG = ProdConfig if os.environ.get('NTR_WEB_ENV') == 'prod' else DevConfig
